 ...
 * of the envelope sit five structured payloads, modelled as a discriminated
...
/** The five QA event categories, used as the discriminant on {@link QaEvent}. */
...
export interface AiOutputEvent extends EventEnvelope {
  eventType: "ai_output";
  /** The raw AI output string before any parsing/validation. */
  rawOutput: string;
