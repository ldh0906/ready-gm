...
export const TERRIBLE_GEESE: Scenario = {
  ...
  // openingSeed는 특정 장난을 지정하지 않는다: 첫 임무는 방마다 시드되는 blackboard
  // fronts에서 stage가 '진행 중'인 front(파이/분수대 리본/빵집 종 등 랜덤)로 결정되며,
  // 여기서 구체 장난을 명시하면 2/3 확률로 오프닝 front와 어긋난다(QA-F5/T-3).
  openingSeed:
    "이슬 맺힌 마을 광장, 빨래가 널리고 아침 상이 식어 가는 한가로운 아침. 거위 무리가 " +
    "울타리 뒤에 모여 첫 번째 표적을 노린다. 혼돈의 존재가 오늘의 첫 장난 임무를 속삭인다.",
  endingCondition:
